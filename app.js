...
function renderDestanaMap(c){
 ...
 if(pts.length)map.fitBounds(pts,{padding:[20,20],maxZoom:11});setTimeout(()=>map.invalidateSize(),150);
}
...
function changeSortMode(mode){
  ...
  if($("sortHighestBtn")) $("sortHighestBtn").classList.toggle("active", mode === "highest");
  if($("sortAlphabetBtn")) $("sortAlphabetBtn").classList.toggle("active", mode === "alphabet");
  showKabChartAll();
}
